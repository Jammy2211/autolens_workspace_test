...
"""
file_path = os.path.join(file_path, "sparse_preload")
...
Setup the sparse preload in the Preloads, followed by a sparse preload.
"""

preloads = al.Preloads()
preloads.set_operated_mapping_matrix_with_preloads(fit_0=fit, fit_1=fit)
