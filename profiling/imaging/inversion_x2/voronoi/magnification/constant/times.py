...
use_w_tilde = True
if use_w_tilde:
    file_path = os.path.join(file_path, "w_tilde_double_einstein_ring")
else:
    file_path = os.path.join(file_path, "mapping_double_einstein_ring")
...
"""
dataset_path = path.join("dataset", "imaging", "double_einstein_ring", instrument)
