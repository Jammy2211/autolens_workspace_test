...
# instrument = "vro"
# instrument = "euclid"
instrument = "hst_offset_centre_and_mass"
# instrument = "hst_up"
# instrument = "ao"
...
pixelization = al.Pixelization(
    image_mesh=al.image_mesh.Overlay(shape=(40, 40)), mesh=mesh, regularization=regularization
)
...
start = time.time()
print()
print(fitness.call(param_vector))
print("Numba Time To JIT Function:", time.time() - start)

start = time.time()
print()
print(fitness.call(param_vector))
print("Numba Time taken using JIT:", time.time() - start)
...
file_path = f"{os.path.join(al.__version__)}_numba"
