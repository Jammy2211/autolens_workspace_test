...
print("Time to Import Standard Libraries: ", time.time() - start)

start = time.time()

import autoarray as aa

print("Time to Import AutoArray: ", time.time() - start)

start = time.time()

import autofit as af

print("Time to Import AutoFit: ", time.time() - start)

start = time.time()

import autogalaxy as ag

print("Time to Import AutoGalxy:: ", time.time() - start)

start = time.time()

import autolens as al

print("Time to Import AutoLens: ", time.time() - start)

start = time.time()

import autolens.plot as aplt

print("Time to Import AutoLens Plotting: ", time.time() - start)
