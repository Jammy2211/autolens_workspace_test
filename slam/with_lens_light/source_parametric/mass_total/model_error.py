...
settings_autofit = af.SettingsSearch(
    path_prefix=path.join(
        "slam", "light_sersic__mass_total__source_parametric", "no_hyper"
    ),
    number_of_cores=1,
    session=None,
)
...
lens_bulge = af.Model(al.lp.SersicCore)
...
model = mass_results.last.model
print(model)
print(model.galaxies.lens.intensity)
stop
