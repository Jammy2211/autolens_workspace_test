...
settings_autofit = af.SettingsSearch(
    path_prefix=path.join("slam", "mass_total__source_pixelization", "no_hyper"),
    number_of_cores=1,
    session=None,
    info={"test": "hello"},
)
...
"""
analysis = al.AnalysisImaging(dataset=imaging, raise_inversion_positions_likelihood_exception=False)
...
analysis = al.AnalysisImaging(
    dataset=imaging, hyper_dataset_result=source_pixelization_results.last, raise_inversion_positions_likelihood_exception=False
)
