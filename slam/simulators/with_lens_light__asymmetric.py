...
`/autolens_workspace/dataset/imaging/with_lens_light__asymmetric/light_sersic__mass_sie__source_sersic`
"""
...
"""
The dataset can be viewed in the folder `autolens_workspace/imaging/with_lens_light__asymmetric/light_sersic__mass_sie__source_sersic`.
"""
