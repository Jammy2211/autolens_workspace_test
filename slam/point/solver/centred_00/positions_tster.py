...
from test_autolens.point_solver import util
import os
...
"""Use a `PointSolver` which uses grid upscaling."""

solver = al.PointSolver(grid=grid, pixel_scale_precision=0.01, upscale_factor=3)
