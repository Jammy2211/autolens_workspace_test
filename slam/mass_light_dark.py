...
def no_lens_light(
    ...
    setup_hyper: al.SetupHyper,
    source_results: af.ResultsCollection,
    lens_bulge: af.Model = af.Model(al.lp.Sersic),
    lens_disk: Optional[af.Model] = None,
    lens_envelope: Optional[af.Model] = None,
    dark: af.Model = af.Model(al.mp.NFWMCRLudlow),
    smbh: Optional[af.Model] = None,
...
def with_lens_light__from_light_linear(
    settings_autofit: af.SettingsSearch,
    analysis: Union[al.AnalysisImaging, al.AnalysisInterferometer],
    setup_hyper: al.SetupHyper,
    source_results: af.ResultsCollection,
    ...
    lens_envelope = slam_util.lmp_from(lp=instance.galaxies.lens.envelope, fit=fit)
