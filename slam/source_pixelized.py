...
def no_lens_light(
    ...
    search = af.DynestyStatic(
        name="source_pixelized[1]_mass[fixed]_source[pixelization_magnification_initialization]",
    ...
    search = af.DynestyStatic(
        name="source_pixelized[3]_mass[fixed]_source[pixelization_initialization]",
        **settings_autofit.search_dict,
        nlive=30,
        dlogz=10.0,
    )
...
def with_lens_light(
    ...
    search = af.DynestyStatic(
        name="source_pixelized[1]_light[fixed]_mass[fixed]_source[pixelization_magnification_initialization]",
        **settings_autofit.search_dict,
        nlive=30,
    )
    ...
    search = af.DynestyStatic(
        name="source_pixelized[2]_light[fixed]_mass[total]_source[pixelization_magnification]",
        **settings_autofit.search_dict,
        nlive=50,
    )
    ...
    search = af.DynestyStatic(
        name="source_pixelized[3]_light[fixed]_mass[fixed]_source[pixelization_initialization]",
        **settings_autofit.search_dict,
        nlive=30,
        dlogz=10.0,
    )
    ...
    search = af.DynestyStatic(
        name="source_pixelized[4]_light[fixed]_mass[total]_source[pixelization]",
        **settings_autofit.search_dict,
        nlive=50,
    )
