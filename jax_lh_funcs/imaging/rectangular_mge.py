...
file_path = os.path.join(al.__version__) + "jax_fft/" + lh_type + "_mge"
...
# Save figure of merit to figure_of_merit.txt file

with open(os.path.join(file_path, "figure_of_merit.txt"), "w") as f:

    f.write(f"{fit.figure_of_merit}\n")
