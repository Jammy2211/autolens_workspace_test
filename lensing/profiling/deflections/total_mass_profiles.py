...
def time_deflections_yx_2d_from(mass_profile):
    start = time.time()
    for i in range(repeats):
        mass_profile.deflections_yx_2d_from(grid=grid)
...
profiling_dict[mass_profile.__class__.__name__] = time_deflections_yx_2d_from(
...
profiling_dict[f"{mass_profile.__class__.__name__}"] = time_deflections_yx_2d_from(
    mass_profile=mass_profile
)
