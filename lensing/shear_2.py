...
shear_y_via_hessian, shear_x_via_hessian = shear.shear_yx_via_hessian_from(grid=grid)
print("")
shear_y_via_jacobian, shear_x_via_jacobian = shear.shear_yx_via_jacobian_from(grid=grid)
