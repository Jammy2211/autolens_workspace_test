def fit():
    ...
    settings_search = af.SettingsSearch(
        path_prefix=path.join("slam", "multi", "shared_parameter"),
        number_of_cores=1,
        session=None,
    )
    ...
    source_pix_results = slam_multi.source_pix.run(
        settings_search=settings_search,
        analysis=analysis,
    ...
    light_results = slam_multi.light_lp.run(
        settings_search=settings_search,
        analysis=analysis,
    ...
    mass_results = slam_multi.mass_total.run(
        settings_search=settings_search,
        analysis=analysis,
        source_results=source_pix_results,
    ...
    subhalo_results = slam_multi.subhalo.detection.run(
        settings_search=settings_search,
        analysis=analysis,
